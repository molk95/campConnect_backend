                ...
                withSonarQubeEnv(params.SONARQUBE_SERVER) {
                    script {
                        def sonarArgs = [
                            ...
                            '-Dsonar.sources=src/main/java/com/esprit/campconnect/Event,src/main/java/com/esprit/campconnect/Reservation,src/main/java/com/esprit/campconnect/Livraison,src/main/java/com/esprit/campconnect/siteCamping,src/main/java/com/esprit/campconnect/SiteCampingAvis,src/main/java/com/esprit/campconnect/InscriptionSite',
                            '-Dsonar.tests=src/test/java/com/esprit/campconnect/Event,src/test/java/com/esprit/campconnect/Reservation,src/test/java/com/esprit/campconnect/Livraison,src/test/java/com/esprit/campconnect/siteCamping,src/test/java/com/esprit/campconnect/SiteCampingAvis,src/test/java/com/esprit/campconnect/InscriptionSite',
